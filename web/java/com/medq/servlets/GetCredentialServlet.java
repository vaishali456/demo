 ...
 * @author eshine
 */
@WebServlet(name = "GetCredentialsServlet", urlPatterns = {"/getcredentials"})
public class GetCredentialServlet extends CoreJSONServlet {
    ...
    protected Object execServiceJSON(Service api, HttpServletRequest request, HttpSession session, HttpServletResponse response) throws Exception {
        ...
        Gson gson = new Gson();
        return gson.toJson(api.getCredentials());
    }
