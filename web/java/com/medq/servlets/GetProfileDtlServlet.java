 ...
 * @author eshine
 */
@WebServlet(name = "GetProfileDtlServlet", urlPatterns = {"/getProfileDtl"})
public class GetProfileDtlServlet extends CoreJSONServlet {
    ...
    protected Object execServiceJSON(Service api, HttpServletRequest request, HttpSession session, HttpServletResponse response) throws Exception {
        ...
        Gson gson = new Gson();
        return gson.toJson(api.getProfileDtl());
    }
