...
@WebServlet(name = "GetContactListServlet", urlPatterns = {"/getcontactlist"})
public class GetContactListServlet extends CoreJSONServlet {
    ...
    protected Object execServiceJSON(Service api, HttpServletRequest request, HttpSession session, HttpServletResponse response) throws Exception {
        ...
        Gson gson = new Gson();
        return gson.toJson(api.getMyContactList());
    }
}
