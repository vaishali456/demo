 ...
 * @author eshine
 */
@WebServlet(name = "GetNotificationsServlet", urlPatterns = {"/notifications"})
public class GetNotificationsServlet extends CoreJSONServlet {
    ...
    protected Object execServiceJSON(Service api, HttpServletRequest request, HttpSession session, HttpServletResponse response) throws Exception {
        ...
        Gson gson = new Gson();
        return gson.toJson(api.getNotifications());
    }
}
